...
import (
	...
	lsp "command-line-arguments/home/kenny/src/1_github/trankhanh040147/prepf/internal/lsp/client.go"
	...
	"github.com/trankhanh040147/prepf/internal/format"
...
func (app *App) InitCoderAgent(ctx context.Context) error {
	...
	app.AgentCoordinator, err = agent.NewCoordinator(
		...
		app.Permissions,
		app.History,
		csync.NewMap[string, *lsp.Client](),
	)
	if err != nil {
