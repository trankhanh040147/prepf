...
func TestShouldExcludeFile(t *testing.T) {
	...
	if err := os.WriteFile(filepath.Join(tempDir, ".prepfignore"), []byte(crushignoreContent), 0o644); err != nil {
...
func TestShouldExcludeFileHierarchical(t *testing.T) {
	...
	if err := os.WriteFile(filepath.Join(subDir, ".prepfignore"), []byte(subCrushignore), 0o644); err != nil {
